<?php
  ...
  {
    $formatDetected = MagicParser_getFormat($config_voucherCodesFeedDirectory.$filename);

    print "<h3>".translate("Register")." (".$filename.") ".translate("Step 1 - Feed Format")."</h3>";

    widget_formBegin("GET","voucher_feeds_register_step2.php");
    ...
    $optionsFormatSelected[""] = "Select Format...";
  ...
  {
    widget_errorDisplay("At least 1 product feed must be imported before registering a voucher code feed");
  }
